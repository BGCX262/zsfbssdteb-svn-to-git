...
public class Background implements IFbsData, Cloneable {
	...
	public Object clone() {
		Background o = null;
		try {
			o = (Background) super.clone();
		} catch (CloneNotSupportedException e) {
			e.printStackTrace();
		}
		o.bgType = bgType;
		o.color = new Color(color.getRGB());
		o.pictureImageFilePath = pictureImageFilePath == null ? null : new String(pictureImageFilePath);
		o.marbleImageFilePath = marbleImageFilePath == null ? null : new String(marbleImageFilePath);
		return o; 
	}

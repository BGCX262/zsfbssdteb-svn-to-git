...
public class About extends JFrame {
	...
	public About(ComponentListener componentListener) {
		...
		JLabel label = new JLabel("新学友.五好学生.电子白板软件");
		label.setHorizontalAlignment(SwingConstants.CENTER);
		panel.add(label);
		
		JLabel label2 = new JLabel("Five Best Student Board V0.6");
		label2.setHorizontalAlignment(SwingConstants.CENTER);
		panel.add(label2);
		
		JLabel label4 = new JLabel("");
		label4.setIcon(ImageTool.getResImageIcon("/res/images/logo.png"));
